   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Transaksi
                    ...
                    <a href="#" data-toggle="modal"  data-target="#largeModal" class="pull-right btn btn-success ">Pilih Barang</a>
                </h1> 
            </div>
        </div>
        <!-- /.row -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Untuk Bantuan - <?php echo '0895371752686';?> - Ailee Tech</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
