...
<head>
      ...
      <title>Kasir - Toko Besi Mas Shofi</title>
...
<body>
      ...
      <div class="container">
            ...
            <div class="row">
                  <div class="col-lg-12">
                        <h1 class="page-header" style="color:#fcc;">Kasir
                              <small>Toko Besi Mas Shofi</small>
                        </h1>
                  </div>
            </div>
            <!-- /.row -->
                              ...
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item green" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/penjualan' ?>" data-toggle="modal">
                                                ...
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Transaksi</p>
                                          </a>
                                    </div>
                              </div>
                              ...
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item purple" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/barang' ?>" data-toggle="modal">
                                                ...
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Barang</p>
                                          </a>
                                    </div>
                              </div>
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item color" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/kategori' ?>" data-toggle="modal">
                                                ...
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Kategori</p>
                                          </a>
                                    </div>
                              </div>
                              <!-- <div class="col-md-3 portfolio-item">
                                    <div class="menu-item green" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/penjualan_grosir' ?>" data-toggle="modal">
                                                ...
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Penjualan Grosir</p>
                                          </a>
                                    </div>
                              </div> -->
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item light-orange" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/suplier' ?>" data-toggle="modal">
                                                ...
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Suplier</p>
                                          </a>
                                    </div>
                              </div>
                              ...
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item blue" style="height:150px;">
                                          <a href="#" data-toggle="modal">
                                                <i class="fa fa-shopping-cart"></i>
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Penjualan Eceran</p>
                                          </a>
                                    </div>
                              </div>
                              <div class="col-md-3 portfolio-item">
                              ...
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item red" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/pengguna' ?>" data-toggle="modal">
                                                <i class="fa fa-users"></i>
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Pengguna</p>
                                          </a>
                                    </div>
                              </div>
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item blue" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/laporan' ?>" data-toggle="modal">
                                                ...
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Laporan</p>
                                          </a>
                                    </div>
                              </div>
                              <div class="col-md-3 portfolio-item">
                                    <div class="menu-item light-red" style="height:150px;">
                                          <a href="<?php echo base_url() . 'admin/pembelian' ?>" data-toggle="modal">
                                                <i class="fa fa-cubes"></i>
                                                <p style="text-align:left;font-size:16px;padding-left:5px;">Pembelian</p>
                                          </a>
                                    </div>
                              </div>
                        <?php } ?>
